      ...
      <div className="w-full h-full relative">
          ...
          {uploadedImage && (
            <div className="absolute top-3 left-3 pointer-events-auto z-[1600]">
              ...
              >
                ...
                <div
                  className={`absolute bottom-0 left-0 right-0 text-[9px] text-center py-0.5 ${isDark ? "bg-black/70 text-gray-300" : "bg-white/80 text-gray-600"}`}
                >
                  设计稿
                </div>
              </div>
        ...
        <div className="absolute top-3 left-1/2 -translate-x-1/2 z-[2000] w-[90%] max-w-lg">
          ...
          >
                ...
                <button
                  ...
                  className={`w-12 h-12 flex items-center justify-center border rounded-xl transition-all ${
                    isDark
                      ...
                      : "border-red-400 hover:bg-red-50 text-red-500"
                  }`}
                  title="取消生成"
                >
            ...
            <div
              className={`mt-3 ${isDark ? "text-gray-500" : "text-gray-400"}`}
            >
              {isStreaming ? (
